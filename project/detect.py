...
# Load model
model = YOLO("models/yolov8n.pt")  # ADRESİ DÜZENLE !
labels = model.names
...
while True:
    ...
    cv2.putText(
        frame, "FPS: " + str(avg_fps), (20, 40), font, 1.5, text_color_b, thickness=3
    )
...
writer = cv2.VideoWriter(
    save_path, cv2.VideoWriter_fourcc(*"XVID"), int(avg_fps), (width, height)
)
